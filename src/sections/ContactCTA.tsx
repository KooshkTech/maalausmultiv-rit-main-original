      ...
      <div className="container-base">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
          <Reveal className="lg:col-span-5">
            ...
            <h2 className="mt-4 font-display text-3xl font-bold leading-tight text-navy-900 sm:text-4xl lg:text-5xl">
              Pyydä ilmainen, sitoutumaton tarjous
            </h2>
            <p className="mt-5 text-base leading-relaxed text-navy-600 sm:text-lg">
              Täytä lomake niin palaamme asiaan 24 tunnin sisällä. Voit myös soittaa
              tai lähettää sähköpostia — vastaamme mielelläm kaikkiin kysymyksiisi.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-5">
              <a href={company.phoneHref} className="group flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-medium uppercase tracking-wider text-navy-500">Soita</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-medium uppercase tracking-wider text-navy-500">Osoite</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-display text-sm font-bold text-navy-900">Ma–Pe 07–18 · La 09–15 · Su suljettu</p>
                </div>
              </div>
            </div>

            <Link to="/projektit" className="btn-outline mt-8">
