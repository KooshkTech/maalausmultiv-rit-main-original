...
export const keywordMap: KeywordTarget[] = [
  ...
  { keyword: 'talon maalaus', cluster: 'painting', intent: 'transactional', location: 'general', priority: 'P1', targetPath: '/palvelut/ulkomaalaus', notes: 'Map to exterior painting unless a dedicated page is justified.' },
  ...
  { keyword: 'sisämaalaus Helsinki', cluster: 'painting', intent: 'transactional', location: 'Helsinki', priority: 'P1', targetPath: '/palvelualueet/helsinki', notes: 'Use location page + service section; dedicated combination page later if justified.' },
  { keyword: 'ulkomaalaus Vantaa', cluster: 'painting', intent: 'transactional', location: 'Vantaa', priority: 'P1', targetPath: '/palvelualueet/vantaa', notes: 'Use local service section.' },
  { keyword: 'julkisivumaalaus Helsinki', cluster: 'painting', intent: 'transactional', location: 'Helsinki', priority: 'P1', targetPath: '/palvelualueet/helsinki', notes: 'High-value project intent.' },
