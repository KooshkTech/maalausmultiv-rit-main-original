...
define('HF_IMAGE_PROVIDER_MODEL', getenv('HF_IMAGE_PROVIDER_MODEL') ?: 'fal-ai/flux-kontext/dev');
define('HF_IMAGE_ENDPOINT', getenv('HF_IMAGE_ENDPOINT') ?: 'https://router.huggingface.co/fal-ai/' . HF_IMAGE_PROVIDER_MODEL . '?_subdomain=queue');
